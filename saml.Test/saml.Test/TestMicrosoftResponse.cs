...
namespace Saml.Test
{
    ...
    public class TestMicrosoftResponse
    {
        ...
        public void TestGetters()
        {
            ...
            DateTime validTo = response.GetValidUntilUtc();

            Assert.AreEqual("_dd3e524d-fe0a-4acc-8310-09b00743c6a0", id);
            ...
            Assert.AreEqual(new DateTime(2018, 12, 17, 1, 7, 8, 665), validTo);
        }
